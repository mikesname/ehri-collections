...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repository.created_on'
        db.add_column('repositories_repository', 'created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 1, 25)), keep_default=False)

        # Adding field 'Repository.updated_on'
        db.add_column('repositories_repository', 'updated_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('repositories_repository', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 1, 25)), keep_default=False)

        # Deleting field 'Repository.created_on'
        db.delete_column('repositories_repository', 'created_on')

        # Deleting field 'Repository.updated_on'
        db.delete_column('repositories_repository', 'updated_on')
