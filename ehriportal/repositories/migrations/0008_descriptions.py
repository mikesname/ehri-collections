...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Repository.authorized_form_of_name'
        db.delete_column('repositories_repository', 'authorized_form_of_name')

        # Adding field 'Repository.name'
        db.add_column('repositories_repository', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Repository.authorized_form_of_name'
        db.add_column('repositories_repository', 'authorized_form_of_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Repository.name'
        db.delete_column('repositories_repository', 'name')
