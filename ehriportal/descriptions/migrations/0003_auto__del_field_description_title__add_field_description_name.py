...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('descriptions_description', 'title')

        # Adding field 'Description.name'
        db.add_column('descriptions_description', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Description.title'
        db.add_column('descriptions_description', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Description.name'
        db.delete_column('descriptions_description', 'name')
