...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.tlod'
        db.add_column('portal_collection', 'tlod', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Collection.ttype_of_entity'
        db.add_column('portal_collection', 'ttype_of_entity', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Repository.tlod'
        db.add_column('portal_repository', 'tlod', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Repository.ttype_of_entity'
        db.add_column('portal_repository', 'ttype_of_entity', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.tlod'
        db.delete_column('portal_collection', 'tlod')

        # Deleting field 'Collection.ttype_of_entity'
        db.delete_column('portal_collection', 'ttype_of_entity')

        # Deleting field 'Repository.tlod'
        db.delete_column('portal_repository', 'tlod')

        # Deleting field 'Repository.ttype_of_entity'
        db.delete_column('portal_repository', 'ttype_of_entity')
    ...
    models = {
        ...
        'portal.collection': {
            ...
            'tlod': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'ttype_of_entity': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'portal.contact': {
