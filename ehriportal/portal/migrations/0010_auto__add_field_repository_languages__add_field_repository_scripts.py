...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repository.languages'
        db.add_column('portal_repository', 'languages', self.gf('jsonfield.fields.JSONField')(default='[]'), keep_default=False)

        # Adding field 'Repository.scripts'
        db.add_column('portal_repository', 'scripts', self.gf('jsonfield.fields.JSONField')(default='[]'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repository.languages'
        db.delete_column('portal_repository', 'languages')

        # Deleting field 'Repository.scripts'
        db.delete_column('portal_repository', 'scripts')
