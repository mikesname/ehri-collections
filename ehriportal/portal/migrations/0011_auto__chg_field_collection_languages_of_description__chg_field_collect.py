...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.languages_of_description'
        db.alter_column('portal_collection', 'languages_of_description', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Collection.scripts_of_description'
        db.alter_column('portal_collection', 'scripts_of_description', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Collection.languages'
        db.alter_column('portal_collection', 'languages', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Collection.scripts'
        db.alter_column('portal_collection', 'scripts', self.gf('jsonfield.fields.JSONField')())


    def backwards(self, orm):
        
        # Changing field 'Collection.languages_of_description'
        db.alter_column('portal_collection', 'languages_of_description', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Collection.scripts_of_description'
        db.alter_column('portal_collection', 'scripts_of_description', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Collection.languages'
        db.alter_column('portal_collection', 'languages', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Collection.scripts'
        db.alter_column('portal_collection', 'scripts', self.gf('jsonfield.fields.JSONField')(null=True))
