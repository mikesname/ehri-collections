...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('portal_repository', 'tidentifier', 'identifier')
        db.rename_column('portal_collection', 'tidentifier', 'identifier')

    def backwards(self, orm):
        db.rename_column('portal_repository', 'identifier', 'tidentifier')
        db.rename_column('portal_collection', 'identifier', 'tidentifier')
