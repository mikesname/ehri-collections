...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute("""update portal_repository t, portal_resource s set t.rname = s.name, 
                        t.rslug = s.slug where t.resource_ptr_id = s.id;""")
        db.execute("""update portal_collection t, portal_resource s set t.cname = s.name, 
                        t.cslug = s.slug where t.resource_ptr_id = s.id;""")

    def backwards(self, orm):
        "Write your backwards methods here."
        db.execute("""update portal_resource t, portal_repository s set t.name = s.rname, 
                        t.slug = s.rslug where t.resource_ptr_id = s.id;""")
        db.execute("""update portal_resource t, portal_collection s set t.name = s.cname, 
                        t.slug = s.cslug where t.resource_ptr_id = s.id;""")
