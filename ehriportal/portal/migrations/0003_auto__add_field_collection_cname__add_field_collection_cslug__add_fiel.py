...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.cname'
        db.add_column('portal_collection', 'cname', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Collection.cslug'
        db.add_column('portal_collection', 'cslug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), populate_from=None, max_length=50, db_index=True), keep_default=False)

        # Adding field 'Repository.rname'
        db.add_column('portal_repository', 'rname', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Repository.rslug'
        db.add_column('portal_repository', 'rslug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), populate_from=None, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.cname'
        db.delete_column('portal_collection', 'cname')

        # Deleting field 'Collection.cslug'
        db.delete_column('portal_collection', 'cslug')

        # Deleting field 'Repository.rname'
        db.delete_column('portal_repository', 'rname')

        # Deleting field 'Repository.rslug'
        db.delete_column('portal_repository', 'rslug')
    ...
    models = {
        ...
        'portal.collection': {
            ...
            'cslug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': 'None', 'unique_with': '()', 'db_index': 'True'}),
        ...
        'portal.repository': {
            ...
            'rslug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': 'None', 'unique_with': '()', 'db_index': 'True'}),
            'rules': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sources': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'portal.resource': {
