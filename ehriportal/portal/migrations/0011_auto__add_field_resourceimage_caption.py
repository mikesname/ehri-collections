...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceImage.caption'
        db.add_column('portal_resourceimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResourceImage.caption'
        db.delete_column('portal_resourceimage', 'caption')
