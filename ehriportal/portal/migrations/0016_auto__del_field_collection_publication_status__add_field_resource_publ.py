...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.publication_status'
        db.delete_column('portal_collection', 'publication_status')

        # Adding field 'Resource.publication_status'
        db.add_column('portal_resource', 'publication_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Collection.publication_status'
        db.add_column('portal_collection', 'publication_status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Resource.publication_status'
        db.delete_column('portal_resource', 'publication_status')
    ...
    models = {
        ...
        'portal.resource': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publication_status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
