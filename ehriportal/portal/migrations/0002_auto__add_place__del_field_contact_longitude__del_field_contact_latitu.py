...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contact.longitude'
        db.delete_column('portal_contact', 'longitude')

        # Deleting field 'Contact.latitude'
        db.delete_column('portal_contact', 'latitude')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Contact.longitude'
        db.add_column('portal_contact', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Contact.latitude'
        db.add_column('portal_contact', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
