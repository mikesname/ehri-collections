...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('portal_repository', 'tlod', 'lod')
        db.rename_column('portal_repository', 'ttype_of_entity', 'type_of_entity')
        db.rename_column('portal_collection', 'tlod', 'lod')
        db.rename_column('portal_collection', 'ttype_of_entity', 'type_of_entity')

    def backwards(self, orm):
        db.rename_column('portal_repository', 'lod', 'tlod')
        db.rename_column('portal_repository', 'type_of_entity', 'ttype_of_entity')
        db.rename_column('portal_collection', 'lod', 'tlod')
        db.rename_column('portal_collection', 'type_of_entity', 'ttype_of_entity')
