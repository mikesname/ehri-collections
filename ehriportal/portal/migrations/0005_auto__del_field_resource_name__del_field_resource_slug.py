...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('portal_resource', 'name')

        # Deleting field 'Resource.slug'
        db.delete_column('portal_resource', 'slug')


    def backwards(self, orm):
        
        # Adding field 'Resource.name'
        db.add_column('portal_resource', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Resource.slug'
        db.add_column('portal_resource', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), populate_from=None, max_length=50, unique=True, db_index=True), keep_default=False)
