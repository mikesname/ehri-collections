...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Resource.lod'
        db.delete_column('portal_resource', 'lod')

        # Deleting field 'Resource.type_of_entity'
        db.delete_column('portal_resource', 'type_of_entity')


    def backwards(self, orm):
        
        # Adding field 'Resource.lod'
        db.add_column('portal_resource', 'lod', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Resource.type_of_entity'
        db.add_column('portal_resource', 'type_of_entity', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
