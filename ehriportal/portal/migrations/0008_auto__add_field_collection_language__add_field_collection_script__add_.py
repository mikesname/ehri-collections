...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.language'
        db.add_column('portal_collection', 'languages', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Adding field 'Collection.script'
        db.add_column('portal_collection', 'scripts', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Adding field 'Collection.language_of_description'
        db.add_column('portal_collection', 'languages_of_description', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Adding field 'Collection.script_of_description'
        db.add_column('portal_collection', 'scripts_of_description', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.language'
        db.delete_column('portal_collection', 'languages')

        # Deleting field 'Collection.script'
        db.delete_column('portal_collection', 'scripts')

        # Deleting field 'Collection.language_of_description'
        db.delete_column('portal_collection', 'languages_of_description')

        # Deleting field 'Collection.script_of_description'
        db.delete_column('portal_collection', 'scripts_of_description')
    ...
    models = {
        ...
        'portal.collection': {
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'institution_responsible_identifier': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'languages': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'languages_of_description': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'scripts': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'scripts_of_description': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': 'None', 'unique_with': '()', 'db_index': 'True'}),
            'sources': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'portal.contact': {
