...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Collection.type_of_entity'
        db.delete_column('portal_collection', 'type_of_entity')


    def backwards(self, orm):
        
        # Adding field 'Collection.type_of_entity'
        db.add_column('portal_collection', 'type_of_entity', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
