...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.creator'
        db.add_column('portal_collection', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.Authority'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.creator'
        db.delete_column('portal_collection', 'creator_id')
