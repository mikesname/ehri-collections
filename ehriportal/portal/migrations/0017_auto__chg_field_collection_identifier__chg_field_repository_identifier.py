...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.identifier'
        db.alter_column('portal_collection', 'identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Repository.identifier'
        db.alter_column('portal_repository', 'identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Collection.identifier'
        db.alter_column('portal_collection', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Repository.identifier'
        db.alter_column('portal_repository', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
