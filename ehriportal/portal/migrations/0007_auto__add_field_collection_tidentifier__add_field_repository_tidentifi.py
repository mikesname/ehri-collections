...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.tidentifier'
        db.add_column('portal_collection', 'tidentifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding field 'Repository.tidentifier'
        db.add_column('portal_repository', 'tidentifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.tidentifier'
        db.delete_column('portal_collection', 'tidentifier')

        # Deleting field 'Repository.tidentifier'
        db.delete_column('portal_repository', 'tidentifier')
