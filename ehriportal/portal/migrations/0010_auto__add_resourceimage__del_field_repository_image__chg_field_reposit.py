...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portal_resourceimage', (
            ...
            ('image', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(max_length=100, name='image', sizes=((100, 100), (300, 300)))),
        ))
        db.send_create_signal('portal', ['ResourceImage'])

        # Deleting field 'Repository.image'
        db.delete_column('portal_repository', 'image')

        # Changing field 'Repository.logo'
        db.alter_column('portal_repository', 'logo', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(name='logo', sizes=((100, 100), (300, 300)), max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Repository.image'
        db.add_column('portal_repository', 'image', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(blank=True, max_length=100, null=True, name='image', sizes=((125, 125), (300, 300))), keep_default=False)

        # Changing field 'Repository.logo'
        db.alter_column('portal_repository', 'logo', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(max_length=100, null=True, name='logo', sizes=((125, 125), (300, 300))))
    ...
    models = {
        ...
        'portal.repository': {
            ...
            'logo': ('ehriportal.portal.thumbs.ImageWithThumbsField', [], {'name': "'logo'", 'sizes': '((100, 100), (300, 300))', 'max_length': '100', 'blank': 'True', 'null': 'True'}),
        ...
        'portal.resourceimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('ehriportal.portal.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'name': "'image'", 'sizes': '((100, 100), (300, 300))'}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portal.Resource']"})
        },
        'taggit.tag': {
