...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('portal_repository', 'rname', 'name')
        db.rename_column('portal_repository', 'rslug', 'slug')
        db.rename_column('portal_collection', 'cname', 'name')
        db.rename_column('portal_collection', 'cslug', 'slug')


    def backwards(self, orm):
        db.rename_column('portal_repository', 'name', 'rname')
        db.rename_column('portal_repository', 'slug', 'rslug')
        db.rename_column('portal_collection', 'name', 'cname')
        db.rename_column('portal_collection', 'slug', 'cslug')
