...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repository.image'
        db.alter_column('portal_repository', 'image', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(name='image', sizes=((125, 125), (300, 300)), max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Repository.image'
        db.alter_column('portal_repository', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
