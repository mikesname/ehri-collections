...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repository.logo'
        db.add_column('portal_repository', 'logo', self.gf('ehriportal.portal.thumbs.ImageWithThumbsField')(name='logo', sizes=((125, 125), (300, 300)), max_length=100, blank=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repository.logo'
        db.delete_column('portal_repository', 'logo')
    ...
    models = {
        ...
        'portal.repository': {
            ...
            'image': ('ehriportal.portal.thumbs.ImageWithThumbsField', [], {'name': "'image'", 'sizes': '((125, 125), (300, 300))', 'max_length': '100', 'blank': 'True', 'null': 'True'}),
            ...
            'logo': ('ehriportal.portal.thumbs.ImageWithThumbsField', [], {'name': "'logo'", 'sizes': '((125, 125), (300, 300))', 'max_length': '100', 'blank': 'True', 'null': 'True'}),
