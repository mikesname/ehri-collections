...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Resource', fields ['identifier']
        db.delete_unique('portal_resource', ['identifier'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Resource', fields ['identifier']
        db.create_unique('portal_resource', ['identifier'])
